...
def initialize_vllm(args, first_mode: str):
    ...
    return {
        ...
        "allocation_events": integration.state.allocations[request_id].event_count,
...
def run_mode(args, captured: dict, mode: str) -> dict:
    ...
    return {
        ...
        "allocation_events": captured["allocation_events"],
...
def print_summary(args, results: list[dict]) -> None:
    ...
    for result in results:
        print(
            ...
            f"allocation_events={result['allocation_events']}",
...
def run(args) -> None:
    ...
    print(
        ...
        f"allocation_events={captured['allocation_events']}",
